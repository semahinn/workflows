...
namespace Snr\Workflows\Util;

/**
 * !It's full copy of Drupal NestedArray utility class!
 * @see https://api.drupal.org/api/drupal/core%21lib%21Drupal%21Component%21Utility%21NestedArray.php/class/NestedArray/8.9.x
 */
class NestedArray {
